      ...
      >
        ...
        <div className="relative">
          <input
            ...
            required
            disabled={loading}
            className="mdc-input mdc-input--icon-left py-3 sm:py-3 lg:py-4 text-sm sm:text-base lg:text-lg"
          />
        ...
        <button
          type="submit"
          disabled={loading}
          className="mdc-button mdc-button-primary w-full py-3 sm:py-3 lg:py-4 text-sm sm:text-base lg:text-lg"
        >
